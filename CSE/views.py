...
class EmployeeList(ListView):
    model = Employee
    template_name = 'CBV2/list.html'


class EmployeeForms(CreateView):
    model = Employee
    fields = "__all__"
    template_name = 'CBV2/forms.html'
    success_url = '/'


class EmployeeDetail(DetailView):
    model = Employee
    template_name = 'CBV2/detail.html'

class EmployeeUpdate(UpdateView):
    model = Employee
    fields = '__all__'
    template_name = 'CBV2/update.html'
    success_url = '/'


class EmployeeDelete(DeleteView):
    model = Employee
    template_name = 'CBV2/delete.html'
    success_url = '/'
