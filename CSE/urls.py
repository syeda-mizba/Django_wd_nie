...
from CSE.views import EmployeeList, EmployeeForms, EmployeeDetail, EmployeeUpdate, EmployeeDelete
...
urlpatterns = [
    ...
    # CBV
    path('List', StuList.as_view(), name='list'),
    ...
    path('forms1', EmployeeForms.as_view(), name='forms'),
    path('<pk>/detail1', EmployeeDetail.as_view(), name='detail'),
    path('<pk>/update1', EmployeeUpdate.as_view(), name='update'),
    path('<pk>/delete1', EmployeeDelete.as_view(), name='delete'),
